...
const priceCategories = [
  {
    ...
    positions: [
      { title: 'Высшее руководство (генеральный директор)', price: 'от 80 000 ₽' },
      { title: 'Супервайзеры', price: 'от 80 000 ₽' },
      { title: 'Территориальные менеджеры', price: 'от 70 000 ₽' },
      { title: 'Торговые представители', price: 'от 70 000 ₽' },
      { title: 'Руководители среднего звена', price: 'от 60 000 ₽' },
      { title: 'Линейные руководители', price: 'от 50 000 ₽' },
    ],
  },
  {
    category: 'Специалистские должности',
    positions: [
      { title: 'Научные сотрудники, исследователи', price: 'от 100 000 ₽' },
      { title: 'Художественные профессии (дизайнеры, писатели)', price: 'от 100 000 ₽' },
      { title: 'Врачи', price: 'от 60 000 ₽' },
      { title: 'Высококвалифицированные специалисты', price: 'от 50 000 ₽' },
      { title: 'Специалисты среднего уровня', price: 'от 50 000 ₽' },
      { title: 'Специалисты по охране труда', price: 'от 40 000 ₽' },
      { title: 'Младшие специалисты', price: 'от 40 000 ₽' },
      { title: 'Менеджеры по продажам', price: 'от 30 000 ₽' },
      { title: 'Медсестры', price: 'от 20 000 ₽' },
    ],
  },
  {
    category: 'Рабочие должности',
    positions: [
      { title: 'Квалифицированные рабочие (слесари, электрики, операторы)', price: 'от 30 000 ₽' },
      { title: 'Неквалифицированные рабочие (грузчики, подсобные рабочие)', price: 'от 25 000 ₽' },
    ],
  },
  {
    category: 'Обслуживающий персонал',
    positions: [
      { title: 'Технический персонал (водители, уборщики, охрана)', price: 'от 15 000 ₽' },
      { title: 'Административно-хозяйственный персонал', price: 'от 15 000 ₽' },
      { title: 'Парикмахеры / Барберы / Массажисты / Мастера ногтевого сервиса', price: 'от 15 000 ₽' },
    ],
  },
];
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="w-full h-[500px] rounded-2xl overflow-hidden shadow-2xl bg-white">
                <img 

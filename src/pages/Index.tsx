...
const priceCategories = [
  {
    ...
    positions: [
      { title: 'Высшее руководство (генеральный директор)', price: 'от 80 000 руб' },
  ...
  },
  {
    ...
    positions: [
      ...
      { title: 'Художественные профессии (дизайнеры, писатели)', price: 'от 100 000 руб' },
  ...
  },
  {
    ...
    positions: [
      { title: 'Квалифицированные рабочие (слесари, электрики, операторы)', price: 'от 30 000 руб' },
      { title: 'Неквалифицированные рабочие (грузчики, подсобные рабочие)', price: 'от 25 000 руб' },
    ],
  },
  {
    category: 'Обслуживающий персонал',
    positions: [
      { title: 'Технический персонал (водители, уборщики, охрана)', price: 'от 15 000 руб' },
      { title: 'Административно-хозяйственный персонал', price: 'от 15 000 руб' },
      { title: 'Парикмахеры / Барберы / Массажисты / Мастера ногтевого сервиса', price: 'от 15 000 руб' },
    ],
  },
];
